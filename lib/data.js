...
// trending: 지금 화제/유행인 음식이면 true. 이 경우 startTerm/peakTerm/endTerm은 필요 없다
//           (절기 계산을 아예 타지 않고, 항상 "이번 주 제철" 줄에만 노출됨)
// heroOverride: 진짜 메가트렌드라 오늘의 제철 TOP(히어로 카드)에도 넣고 싶을 때만 true로 설정
export const FOODS = {
  chobok: {
    name: "초복",
    emoji: "🍲",
    why: "초복엔 삼계탕 같은 보양식 찾는 분들이 확 늘어나요. 몸보신 제대로 챙기세요.",
    gonggu: [],
    trending: true,
    heroOverride: false,
  },
